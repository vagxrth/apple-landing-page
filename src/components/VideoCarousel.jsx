...
const VideoCarousel = () => {
    ...
    const handleLoadMetadata = (i, e) => setloadedData((prev) => [...prev, e]);
                    ...
                    <div key={list.id} id='slider' className='sm:pr-20 pr-10'>
                        <div className='video-carousel_container'>
                            <div className='w-full h-full flex-center rounded-3xl overflow-hidden bg-black'>
                                <video id='video' playsInline={true} preload='auto' muted className={`${list.id==2 && 'translate-x-44'} pointer-events-none`} ref={(element) => (videoRef.current[i] = element)}
                                    onEnded={() => (
